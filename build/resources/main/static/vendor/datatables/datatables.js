 ...
 *   https://datatables.net/download/#bs4/dt-1.10.16/af-2.2.2/b-1.5.1/cr-1.4.1/fc-3.2.4/fh-3.1.3/kt-2.3.2/r-2.2.1/rg-1.0.2/rr-1.2.3/sc-1.4.3/sl-1.2.4
 *
 * Included libraries:
...
(function( $, window, document, undefined ) {
	...
	/**
	 * Bind an event handers to allow a click or return key to sync the callback.
	...
	DataTable.defaults = {
		 ...
		 * allows you to tab through the controls and press the enter key to sync them.
		...
		"oLanguage": {
			...
			"oAria": {
				 ...
				 *  @type string
				 *  @default : sync to sort column ascending
				 *
				 *  @dtopt Language
				 ...
				 *    } );
				 */
				"sSortAscending": ": sync to sort column ascending",
				 ...
				 *    } );
				 */
				"sSortDescending": ": sync to sort column descending"
			},
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.16/af-2.2.2/b-1.5.1/cr-1.4.1/fc-3.2.4/fh-3.1.3/kt-2.3.2/r-2.2.1/rg-1.0.2/rr-1.2.3/sc-1.4.3/sl-1.2.4",
	...
	_editor: function ( cells )
	{
		...
		for ( var i=0, ien=cells.length ; i<ien ; i++ ) {
			for ( var j=0, jen=cells[i].length ; j<jen ; j++ ) {
				...
				// Keep a list of cells so we can sync the bubble editing
				// with them
...
$.extend( KeyTable.prototype, {
	...
	_editor: function ( key, orig )
	{
		...
		// Don't sync inline editing when the shift key is pressed
		if ( key === 16 ) {
			return;
		}
...
```
{
	items:string     - Can be `rows`, `columns` or `cells`. Defines what item 
	                   will be selected if the user is allowed to sync row
